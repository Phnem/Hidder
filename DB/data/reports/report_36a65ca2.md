# Peripheral Registry Ingestion Report — Run `36a65ca2`

- **Started At**: 2026-08-18T20:02:26.776909+00:00
- **Duration**: 0:25:02
- **Brands Crawled**: 100
- **Total Products in Registry**: 6365 (+27 new)
- **Hardware Devices**: 2360
- **Stored CAS Artifacts**: 205 (5451.70 MB)
- **Artifacts Discovered**: 526
- **Artifacts Downloaded**: 0
- **Cache Hits (Pre-download)**: 204
- **Conditional 304 Hits**: 0
- **Duplicate URLs Skipped**: 295
- **Bytes Downloaded**: 0.00 MB
- **Bytes Avoided by Cache**: 5458.02 MB
- **Discovered VID/PIDs**: 421
- **Protocol Hints**: 104
...
| 6 | **Ajazz** | `SUPPORTED_FULL` | 29 | 23 | 6 | 208 | 1 | 1 |  |
| 7 | **Akko** | `SUPPORTED_FULL` | 37 | 28 | 20 | 9 | 0 | 1 |  |
| 8 | **Alienware** | `METADATA_ONLY` | 1 | 0 | 0 | 0 | 0 | 0 |  |
| 9 | **Attack Shark** | `METADATA_ONLY` | 173 | 102 | 0 | 0 | 0 | 0 |  |
| 10 | **Bloody** | `NO_OFFICIAL_CATALOG_FOUND` | 0 | 0 | 0 | 0 | 0 | 0 | No products or software packages discovered at official endpoints |
| 11 | **CHERRY** | `METADATA_ONLY` | 1 | 0 | 0 | 0 | 0 | 0 |  |
| 12 | **Chilkey** | `METADATA_ONLY` | 54 | 19 | 0 | 0 | 0 | 0 |  |
| 13 | **Chosfox** | `METADATA_ONLY` | 229 | 51 | 0 | 0 | 0 | 0 |  |
| 14 | **Cidoo** | `METADATA_ONLY` | 12 | 10 | 0 | 0 | 0 | 0 |  |
| 15 | **Cooler Master** | `METADATA_ONLY` | 32 | 4 | 0 | 0 | 0 | 0 |  |
| 16 | **Corsair** | `NO_OFFICIAL_CATALOG_FOUND` | 3 | 3 | 0 | 0 | 0 | 0 | No products or software packages discovered at official endpoints |
...
| 29 | **Fantech** | `METADATA_ONLY` | 244 | 95 | 0 | 0 | 0 | 0 |  |
| 30 | **Feker** | `SUPPORTED_FULL` | 5 | 5 | 3 | 1 | 0 | 1 |  |
...
| 34 | **G-Wolves** | `METADATA_ONLY` | 66 | 52 | 0 | 0 | 0 | 0 |  |
| 35 | **Gamakay** | `SUPPORTED_FULL` | 70 | 32 | 4 | 134 | 4 | 4 |  |
| 36 | **Glorious** | `SUPPORTED_FULL` | 227 | 36 | 3 | 0 | 0 | 0 |  |
| 37 | **HHKB** | `SOFTWARE_ONLY` | 0 | 0 | 4 | 0 | 0 | 0 | No product listings found on catalog page |
| 38 | **HyperX** | `SUPPORTED_FULL` | 238 | 80 | 3 | 1 | 7 | 2 |  |
...
| 40 | **IQUNIX** | `METADATA_ONLY` | 12 | 3 | 0 | 0 | 0 | 0 |  |
...
| 43 | **KBDfans** | `SUPPORTED_FULL` | 438 | 129 | 2 | 2 | 0 | 16 |  |
| 44 | **Kemove** | `METADATA_ONLY` | 14 | 11 | 0 | 0 | 0 | 0 |  |
| 45 | **Keychron** | `NOT_RUN` | 0 | 0 | 0 | 0 | 0 | 0 |  |
| 46 | **Keycult** | `METADATA_ONLY` | 38 | 11 | 0 | 0 | 0 | 0 |  |
| 47 | **Kysona** | `METADATA_ONLY` | 10 | 7 | 0 | 0 | 0 | 0 |  |
| 48 | **Kzzi** | `NO_OFFICIAL_CATALOG_FOUND` | 0 | 0 | 0 | 0 | 0 | 0 | No products or software packages discovered at official endpoints |
| 49 | **Lamzu** | `METADATA_ONLY` | 70 | 51 | 0 | 0 | 0 | 0 |  |
| 50 | **Lemokey** | `METADATA_ONLY` | 126 | 23 | 0 | 0 | 0 | 0 |  |
...
| 55 | **MCHOSE** | `SUPPORTED_FULL` | 39 | 26 | 0 | 0 | 0 | 0 |  |
| 56 | **MSI** | `SOFTWARE_ONLY` | 0 | 0 | 1 | 0 | 0 | 0 | No product listings found on catalog page |
| 57 | **Machenike** | `SUPPORTED_FULL` | 137 | 68 | 0 | 0 | 0 | 0 |  |
...
| 60 | **MelGeek** | `METADATA_ONLY` | 103 | 54 | 0 | 0 | 0 | 0 |  |
| 61 | **Meletrix** | `METADATA_ONLY` | 206 | 56 | 0 | 0 | 0 | 0 |  |
| 62 | **Mode Designs** | `METADATA_ONLY` | 76 | 0 | 0 | 0 | 0 | 0 |  |
| 63 | **MonsGeek** | `SUPPORTED_FULL` | 81 | 45 | 15 | 10 | 0 | 11 |  |
| 64 | **NZXT** | `SUPPORTED_FULL` | 128 | 29 | 1 | 0 | 0 | 0 |  |
| 65 | **Ninjutso** | `SUPPORTED_FULL` | 9 | 4 | 2 | 0 | 1 | 1 |  |
| 66 | **NuPhy** | `METADATA_ONLY` | 28 | 18 | 0 | 0 | 0 | 0 |  |
| 67 | **Phylina** | `NO_OFFICIAL_CATALOG_FOUND` | 0 | 0 | 0 | 0 | 0 | 0 | No products or software packages discovered at official endpoints |
| 68 | **Pulsar Gaming Gears** | `SUPPORTED_FULL` | 293 | 163 | 68 | 32 | 10 | 37 |  |
| 69 | **Qwertykeys** | `METADATA_ONLY` | 106 | 54 | 0 | 0 | 0 | 0 |  |
| 70 | **Rapoo** | `METADATA_ONLY` | 1 | 0 | 0 | 0 | 0 | 0 |  |
| 71 | **Rawm** | `METADATA_ONLY` | 27 | 0 | 0 | 0 | 0 | 0 |  |
...
| 75 | **Royal Kludge** | `SUPPORTED_FULL` | 54 | 49 | 5 | 2 | 0 | 2 |  |
| 76 | **Scyrox** | `METADATA_ONLY` | 12 | 7 | 0 | 0 | 0 | 0 |  |
| 77 | **Sikakeyb** | `METADATA_ONLY` | 40 | 32 | 0 | 0 | 0 | 0 |  |
...
| 81 | **Tecware** | `SOFTWARE_ONLY` | 34 | 0 | 34 | 0 | 13 | 11 | No product listings found on catalog page |
| 82 | **Thunderobot** | `BLOCKED_WAF` | 1 | 1 | 0 | 0 | 0 | 0 | HTTP 403 WAF / anti-bot protection |
| 83 | **Turtle Beach** | `METADATA_ONLY` | 1 | 0 | 0 | 0 | 0 | 0 |  |
| 84 | **VAXEE** | `NO_OFFICIAL_CATALOG_FOUND` | 0 | 0 | 0 | 0 | 0 | 0 | No products or software packages discovered at official endpoints |
...
| 94 | **Wuque Studio** | `METADATA_ONLY` | 260 | 41 | 0 | 0 | 0 | 0 |  |
| 95 | **X-Bows** | `METADATA_ONLY` | 13 | 8 | 0 | 0 | 0 | 0 |  |
| 96 | **Xinmeng** | `NO_OFFICIAL_CATALOG_FOUND` | 0 | 0 | 0 | 0 | 0 | 0 | No products or software packages discovered at official endpoints |
| 97 | **YMDK** | `METADATA_ONLY` | 1095 | 148 | 0 | 0 | 0 | 0 |  |
| 98 | **Yunzii** | `METADATA_ONLY` | 487 | 219 | 0 | 0 | 0 | 0 |  |
| 99 | **ZOWIE** | `METADATA_ONLY` | 25 | 23 | 0 | 0 | 0 | 0 |  |
