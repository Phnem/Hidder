# Peripheral Registry Ingestion Report — Run `be140927`

- **Started At**: 2026-08-19T08:20:28.870204+00:00
- **Duration**: 1:19:05
- **Brands Crawled**: 100
- **Total Products in Registry**: 6185 (+6185 new)
- **Hardware Devices**: 2038
...
- **SQLite Database File Size**: 8.46 MB (8,867,840 bytes)
...
4. **Correlated Product**: Product #176 **Q1 Max** (Category: `keyboard`)
5. **Resulting Technical Evidence**:
...
4. **Correlated Product**: Product #3254 **Agar Micro** (Category: `keyboard`)
5. **Resulting Technical Evidence**:
...
| 7 | **Akko** | `SUPPORTED_FULL` | 37 | 27 | 17 | 0 | 0 | 0 |  |
...
| 15 | **Cooler Master** | `METADATA_ONLY` | 33 | 3 | 0 | 0 | 0 | 0 |  |
...
| 26 | **EPOMAKER** | `SUPPORTED_FULL` | 123 | 57 | 2 | 7 | 7 | 7 |  |
...
| 47 | **Kysona** | `METADATA_ONLY` | 10 | 5 | 0 | 0 | 0 | 0 |  |
...
| 77 | **Sikakeyb** | `METADATA_ONLY` | 40 | 30 | 0 | 0 | 0 | 0 |  |
...
| 99 | **ZOWIE** | `METADATA_ONLY` | 25 | 22 | 0 | 0 | 0 | 0 |  |
