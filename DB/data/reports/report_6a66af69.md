# Peripheral Registry Ingestion Report — Run `6a66af69`

- **Started At**: 2026-08-19T05:03:01.659266+00:00
- **Duration**: 0:12:32
- **Brands Crawled**: 100
- **Total Products in Registry**: 6222 (+1 new)
- **Hardware Devices**: 2045
- **Stored CAS Artifacts**: 189 (1784.99 MB)
- **Artifacts Discovered**: 246
- **Artifacts Downloaded**: 0
- **Cache Hits (Pre-download)**: 188
- **Conditional 304 Hits**: 0
- **Duplicate URLs Skipped**: 16
- **Bytes Downloaded**: 0.00 MB
- **Bytes Avoided by Cache**: 1791.30 MB
...
|---|-------|--------|----------|---------|-----------|----------|-------|------------------------|-----------------|
| 1 | **A4Tech** | `METADATA_ONLY` | 22 | 9 | 0 | 0 | 0 | 0 |  |
...
| 38 | **HyperX** | `METADATA_ONLY` | 232 | 82 | 0 | 0 | 0 | 0 |  |
...
| 43 | **KBDfans** | `SUPPORTED_FULL` | 436 | 119 | 2 | 2 | 0 | 2 |  |
...
| 49 | **Lamzu** | `METADATA_ONLY` | 70 | 24 | 0 | 0 | 0 | 0 |  |
...
| 63 | **MonsGeek** | `SUPPORTED_FULL` | 64 | 42 | 13 | 0 | 0 | 0 |  |
...
| 68 | **Pulsar Gaming Gears** | `SUPPORTED_FULL` | 240 | 95 | 68 | 0 | 0 | 0 |  |
| 69 | **Qwertykeys** | `METADATA_ONLY` | 106 | 50 | 0 | 0 | 0 | 0 |  |
...
| 76 | **Scyrox** | `METADATA_ONLY` | 12 | 4 | 0 | 0 | 0 | 0 |  |
| 77 | **Sikakeyb** | `METADATA_ONLY` | 40 | 29 | 0 | 0 | 0 | 0 |  |
...
| 88 | **WLMOUSE** | `METADATA_ONLY` | 65 | 33 | 0 | 0 | 0 | 0 |  |
| 89 | **WOBKEY** | `METADATA_ONLY` | 30 | 12 | 0 | 0 | 0 | 0 |  |
| 90 | **Waizowl** | `METADATA_ONLY` | 14 | 1 | 0 | 0 | 0 | 0 |  |
| 91 | **Weikav** | `BLOCKED_WAF` | 0 | 0 | 0 | 0 | 0 | 0 | HTTP 403 WAF / anti-bot protection |
| 92 | **Womier** | `SUPPORTED_FULL` | 131 | 32 | 1 | 0 | 0 | 0 |  |
| 93 | **Wooting** | `METADATA_ONLY` | 6 | 1 | 0 | 0 | 0 | 0 |  |
| 94 | **Wuque Studio** | `METADATA_ONLY` | 260 | 39 | 0 | 0 | 0 | 0 |  |
...
| 97 | **YMDK** | `METADATA_ONLY` | 1082 | 96 | 0 | 0 | 0 | 0 |  |
