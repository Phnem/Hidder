...
Current ticket: None
Last completed ticket: TICKET-10 (`pregistry` — три оси идентичности вместо линейного ranking)
Next eligible ticket: **TICKET-12** (первый protocol engine, AULA, read-only). Параллельно доступен TICKET-05 (research track).
