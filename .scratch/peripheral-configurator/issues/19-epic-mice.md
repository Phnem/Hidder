...
Будет детализирован при декомпозиции; потребует покупки минимум одной Sinowealth-мыши (аналогично тому, как для клавиатур сначала появилась реальная плата в TICKET-08).
